...
| Layer | Tool | Role |
|-------|------|------|
| **Design** | Paper MCP | Agent draws UI via code-native canvas; I iterate via prompt |
| **Code** | Windsurf + Claude Code | Read Paper artboard, generate Next.js components directly |
| **Intelligence** | Anthropic Claude API | JD parsing and fit scoring at runtime |
| **Cost Optimization** | OpenRouter | Mix models — cheaper for extraction, Sonnet for analysis |
